...
find icons -type f -print0 | xargs -0 sed -i "" "s/_SvgIcon2.default,/'svg', { style: {width: (props.size || '24' + 'px'), height: (props.size || '24' + 'px')}, viewBox: '0 0 24 24', className: props.className },/g"
